...
<script type="text/javascript">
	...
	$('#save').click(function() {
		//alert("saved");
		 ...
		 document.getElementById("frm").action = "${pageContext.request.contextPath}/saveCountryMaster";
	...
	var checked = [];
	$('#num_country_id').val(selectedval);
	...
	if (checked.length > 0) {
		...
		document.getElementById("frm").action = "${pageContext.request.contextPath}/updateCountryMaster";
		document.getElementById("frm").method = "POST";
		document.getElementById("frm").submit();
	...
	$('#delete').click(function() {
		...
		if (checked.length > 0) {
			...
			document.getElementById("frm").action = "${pageContext.request.contextPath}/deleteCountry";
			document.getElementById("frm").method = "POST";
			document.getElementById("frm").submit();
...
//alert(resultArray1[1]);
 ...
 $('#str_country_name').val(resultArray1[1]);
});
});
	...
	<div class="col-lg-12">
		...
		<div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
			...
			<div class="m-portlet__body">
				<form:form  id="frm" name="frm" modelAttribute="CountryMstModel" method="POST" cssClass="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" >
					...
					<form:hidden path="num_country_id" id ="num_country_id" ></form:hidden>	
			...
			<div class="m-portlet__body">
				<form:form  id="frm" name="frm" modelAttribute="CountryMstModel" method="POST" cssClass="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" >
	    			...
	    			<form:input type="hidden" id="num_country_id" path="num_country_id" /> 
				<div class="m-portlet__body">	
					<div class="form-group m-form__group row"> 
					<div class="col-lg-6">
							<label class="label-class">Country Name<span style="color:red;">*</span></label>
							<form:input type="text" path="str_country_name"  class="form-control m-input" id="str_country_name" placeholder="Enter Country Name"/>
