...
function submit_form(){
	document.getElementById("frm").action = "${pageContext.request.contextPath}/saveInstPremisesAddressDetails" 
		//"/DAVA/saveInstPremisesAddressDetails";
...
<body>
	<div class="content-wrapper pt-0 mt-0">
		<section class="regdv content content-tiles">
			...
			<div class="p-0">
				<form:form method="post" id="frm" name="frm" modelAttribute="registrationForm" autocomplete="off" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col">
									<div class="form-group">
										...
										<form:input path="premiseName" type="text" class="form-control" id="preName" placeholder="Enter Premises Name" />
									</div>
								</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col">
									<div class="form-group">
										...
										<form:input path="premiseAddress" type="text" class="form-control" id="address" placeholder="Enter Premises Address" />
									</div>
								</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col">
									<div class="form-group">
										...
										<form:input path="faxNumber" type="text" class="form-control"
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col">
									<div class="form-group">
										...
										<form:input path="gstin" type="text" class="form-control"
											id="gstin" onblur="checksum(this.value)"
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col">
									<div class="form-group">
										...
										<form:input path="gln" type="text" class="form-control"
											id="gln" onblur="checkdigit(this.value)"
											placeholder="Enter GLN Number" />
									</div>	
								</div>
							</div><!--end row-->
						</div><!--end panel body-->
							...
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-12 col">
									<div class="form-group">
										...
										<form:input path="contactPersonName" type="text" class="form-control" id="contactPersonName" placeholder="Enter Contact Person Name" />
									</div>
								</div>
							...
							<div class="row">
									...
									<div class="form-group">
										<label class="dvfrm-label" for="approvalType">Approving Agency:<span style="color:#cd2026;">*</span><span class="iconStyle"
											...
											title="If you want to add approving agency please select other option and add approvig agencies.">
												?</span></label>
										<form:select path="approvalType" class="form-control"
											id="approvalType" onchange="addAppAgency();">
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col">
									<div class="form-group">
										...
										<form:input path="approvalNo" type="text" class="form-control"
											id="approvalNo"
									...
									<div class="form-group">
										...
										<div class="form-group">
											<div class='input-group date' id=''>
												<form:input path="appFromDate" type="date"
													class="form-control" value="" id="appFromDate"
													placeholder="" onchange="checkAppDate();" />
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col">
									<div class="form-group">
										...
										<div class="form-group">
											<div class='input-group date' id=''>
												<form:input path="appToDate" type="date"
													class="form-control" value="" id="appToDate" placeholder=""
													onchange="checkAppDate();" />
								...
								<form:input path="appIssueAuth" type="text" class="form-control" id="appIssueAuth" placeholder="Enter Issuing Authority Name"/>	
							</div>
							</div>
						</div>
					...
					<table id="appTableBody" class="table table-striped table-bordered display table-responsive table-responsive-bordered"
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col">
									<div class="form-group">
										...
										<form:input path="licNo" type="text" class="form-control"
											id="licNo" placeholder="Enter License Number" />
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class='input-group date' id=''>
											<form:input path="fromDate" type="date" class="form-control"
												value="" id="fromDate" placeholder=""
												onchange="checkLicDate();" />
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col">
									<div class="form-group">
										<label class="dvfrm-label" for="issueAuth">Issuing Authority:<span
											style="color:#cd2026;">*</span></label>
										<form:input path="issueAuth" type="text" class="form-control"
											id="issueAuth" placeholder="Enter Issuing Authority Name" />
									</div>
								</div>
					 ...
					 <div class="panel panel-default">
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col">
							...
							<!-- START -->
											...
											<label class="dvfrm-label" for=drugLicenceMF>Upload your Drug license(Create single pdf file of licenses required for this site):<span style="color:#cd2026;">*</span><span class="iconStyle"></span></label>
											<input type="file" class="form-control" name="drugLicenceMF" id="drugLicenceMF" placeholder="Please upload pdf only"  accept="application/pdf" onchange="fileValidation(this.id);getdrugChecksum(this.id);filechecksum(this.id)"/>											  
				...
				<div class="modal modallg fade seminor-login-modal"
					data-backdrop="static" id="modelForAddAppType"
...
function readSuccess1(evt) {
		...
		var somecheck=$('#addressProofId').val().toString();
