...
public class TileDomain extends TransactionInfoDomain {
	...
	@Column(name="str_count_url")
	private String strCountUrl;
	
	public String getStrCountUrl() {
		return strCountUrl;
	}

	public void setStrCountUrl(String strCountUrl) {
		this.strCountUrl = strCountUrl;
	}
